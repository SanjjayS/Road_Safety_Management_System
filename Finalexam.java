...
//                 try{
//                     //String location = "C:\\Users\\Rahul\\Downloads\\Busdetails.accdb";
//                     String databaseURL = "jdbc:derby:database_name;create=true";
...
//         try{
//             //String location = "C:\\Users\\Rahul\\Downloads\\Busdetails.accdb";
//             String databaseURL = "jdbc:derby:testdb;create=true";
//             Connection con = DriverManager.getConnection(databaseURL);
...
//             String databaseURL = "jdbc:derby:table1;create=true";
//             Connection con = DriverManager.getConnection(databaseURL);
//             Statement s = con.createStatement();
//             ResultSet rs = s.executeQuery("select * from POLICE");
//             int j1 = 0;
...
//         left.setBackground(new Color(137, 210, 255));
